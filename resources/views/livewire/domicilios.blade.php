    ...
    <table class="w-full divide-y divide-gray-200">
        <thead>
          <tr>
              ...
              <th scope="col" class="px-6 py-3 bg-gray-50 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" style="width: 16%;">
                ...
                @foreach($domicilios as $i => $domicilio) 
                    <tr>
                        <td class="px-6 py-4 text-center whitespace-nowrap">
                            <div class="text-sm text-gray-500">{{$domicilio->codigo}}</div>
                          
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                          <div class="text-sm text-gray-500">{{$domicilio->admin->name}}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="text-sm text-gray-500">{{$domicilio->domiciliario->name}}</div>
                            <div class="text-sm text-gray-500">{{--$domicilio->Descripcion--}}</div>
        ...
        <tfoot>
          <tr>
            <td colspan="5" class="bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> {{ $domicilios->links() }}</td>
          </tr>
        </tfoot>
